...
public class ElasticsearchConfiguration extends ElasticsearchConfigurationSupport {
    ...
    public ElasticsearchCustomConversions elasticsearchCustomConversions() {
        ...
        converters.add(DateToLocalDateTimeConverter.INSTANCE);//转换器 日期 date 转成LocalDateTime
        converters.add(StringToLocalDateTimeConverter.INSTANCE);//转换器 日期 String 转成LocalDateTime
        converters.add(LongToLocalDateTimeConverter.INSTANCE);//转换器 日期 Long 转成LocalDateTime
